            ...
            <CardContent>
              <Typography variant="body2" color="text.secondary">
                ...
                <Box display="flex" justifyContent="space-between">
                  <FormControl>
                  <InputLabel id="demo-simple-select-label">Add Content</InputLabel>
                    <Select
                    ...
                    >
                      ...
                      <MenuItem component={Link} href={`/addcontent/${space?.id}/text`}>Text</MenuItem>
                      <MenuItem component={Link} href={`/addcontent/${space?.id}/video`}>Video</MenuItem>
                      <MenuItem component={Link} href={`/addcontent/${space?.id}/image`}>Image</MenuItem>
                      <MenuItem component={Link} href={`/addcontent/${space?.id}/meeting`}>Meeting</MenuItem>
                      <MenuItem component={Link} href={`/addcontent/${space?.id}/discussion`}>Discussion</MenuItem>
                    </Select>
                  </FormControl>
