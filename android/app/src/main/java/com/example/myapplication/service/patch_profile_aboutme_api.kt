...
interface patch_profile_aboutme_api {
    @PATCH("profile/")
    fun editAboutMe(@Header("Authorization") Token: String, @Body data: patch_profile_about_me_send_model): Call<profile_see_get_receive_model>
}