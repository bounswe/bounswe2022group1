...
class learningSpace2_remove_fav_api_call {
    fun removeFavorite(add_fav_data: learningSpace2_add_favorite_send_model, onResult: (learningSpace2_add_favorite_receive_model?) -> Unit){

        val retrofit = ServiceBuilder.buildService(learningSpace2_remove_fav_api::class.java)

        retrofit.removeFavorite("Token "+ user_token,add_fav_data).enqueue(
