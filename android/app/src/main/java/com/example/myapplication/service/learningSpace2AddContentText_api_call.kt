...
class learningSpace2AddContentText_api_call {
    fun addContent(userData: learningSpace2AddContentText_send_model, onResult: (learningSpace2AddContent_receive_model?) -> Unit){

        val retrofit = ServiceBuilder.buildService(learningSpace2AddContentText_api::class.java)
